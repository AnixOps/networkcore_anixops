...
FFI boundary design 已补充；Swift/Xcode project、Network Extension target、Rust FFI crate、签名、
TestFlight/App Store 上传和 iOS release asset 均未启用，后续 Apple SDK bridge 与 embedded runtime 源码
必须按 source contract 通过 GitHub Actions 验证。
