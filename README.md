...
- 当前 Windows 客户端 source release 切片是 `v0.2.0-alpha.18`：`apps/windows-gui`
...
`v0.2.0-alpha.18`，最新 stable 是 `v0.1.0`。`v0.2.0-alpha.18` 只由 GitHub Actions 构建并发布
...
当前 Windows source release 目标是 `v0.2.0-alpha.18`，最新 stable 是 `v0.1.0`；
