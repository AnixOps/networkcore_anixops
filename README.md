...
iOS Swift/Network Extension bridge design 已补充；Swift/Xcode project、Network Extension target、签名、
TestFlight/App Store 上传和 iOS release asset 均未启用，后续 Apple SDK bridge 源码必须先补充 source contract
并通过 GitHub Actions 验证。
