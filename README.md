...
iOS Network Extension design 已补充，当前仍为 design-only；Swift/Xcode project、Network Extension target、签名、TestFlight/App Store 上传和 iOS release asset 均未启用，后续 iOS adapter 必须先补齐 source contract 并通过 GitHub Actions 验证。
