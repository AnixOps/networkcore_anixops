...
confirmation source contract、iOS TestFlight/App Store Connect upload workflow source contract 已补充；
...
App Review manual confirmation marker、upload workflow marker 必须按 source contract 通过 GitHub Actions 验证。
