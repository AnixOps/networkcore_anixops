...
- 当前 Windows 客户端待发布切片是 `v0.2.0-alpha.12`：`apps/windows-gui`
...
`v0.2.0-alpha.12`，最新 stable 是 `v0.1.0`。`v0.2.0-alpha.12` 只由 GitHub Actions 构建并发布
...
当前 prerelease 目标是 `v0.2.0-alpha.12`，最新 stable 是 `v0.1.0`；
