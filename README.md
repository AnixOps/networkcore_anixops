...
- 当前 Windows 客户端切片是 `v0.2.0-alpha.2`：`apps/windows-gui`
  ...
  Windows live HTTPS MITM、JavaScript dispatch 与订阅 runnable path 仍未激活。发布合同见
...
`v0.2.0-alpha.2`，最新 stable 是 `v0.1.0`。`v0.2.0-alpha.2` 只由 GitHub Actions 构建并发布
...
当前 prerelease 目标是 `v0.2.0-alpha.2`，最新 stable 是 `v0.1.0`；
