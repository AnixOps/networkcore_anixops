...
`v0.1.0-alpha.10`，由 GitHub Actions 构建并发布 `networkcore-linux` Linux tarball、sha256、manifest
...
当前为 pac-policy-profile-prefs-active/system-mutation-blocked，并明确报告 browser hijack 为 `deferred`。该入口不生成或安装 CA，
