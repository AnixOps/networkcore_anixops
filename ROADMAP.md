...
- 浏览器捕获用户闭环：从 dedicated-profile launch、proxy route verify、proof-log-token traffic proof 和 PAC artifact apply/rollback 推进到完整 live browser traffic proof 自动化、显式代理/system PAC 或系统 mutation、snapshot 和 rollback。
