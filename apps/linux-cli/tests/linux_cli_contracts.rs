...
use networkcore_linux::{
    ...
    MITM_HTTP_REWRITE_DOWNSTREAM_TLS_TERMINATION_PLAN_READY, MITM_HTTP_REWRITE_LIVE_TRAFFIC_READY,
    MITM_HTTP_REWRITE_MUTATION_READY, MITM_HTTP_REWRITE_SOURCE_CONTRACT_STATUS,
    MITM_HTTP_REWRITE_TLS_DECRYPTION_READY, MITM_HTTP_REWRITE_UPSTREAM_TLS_FORWARDING_READY,
