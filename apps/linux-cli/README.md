...
live request/response rewrite, explicit HTTP `CONNECT` pass-through tunnel foundation, `http_rewrite` report, `mitm browser-capture verify --confirm`,
