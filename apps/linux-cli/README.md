...
- Response and diagnostic mapping for help, capabilities, prepare-config, start, stop, status, diagnostics, install-sing-box, run-url, and version commands.
