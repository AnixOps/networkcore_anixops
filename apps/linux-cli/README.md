...
Release/source split: the latest published Linux artifact is `v0.1.0-alpha.20`.
This README describes current `main` source. The `v0.1.0-alpha.20` artifact
...
CONNECT authority output for manual proof audit without switching to JSON.
