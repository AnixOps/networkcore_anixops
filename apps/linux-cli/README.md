...
- Response and diagnostic mapping for help, capabilities, prepare-config, start, stop, status, diagnostics, mitm status/diagnostics/certificate-plan/browser-plan, install-sing-box, run-url, and version commands.
