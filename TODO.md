...
- [ ] 补充 Linux package artifact staging file validation contract，明确真实 build output、INSTALL、LICENSE/NOTICE 和 CHANGELOG 进入 staging 前的文件复制、权限、路径和仍不创建 archive 的边界。
