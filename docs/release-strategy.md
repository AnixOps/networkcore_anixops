...
- 下一步补充 Linux package license/NOTICE confirmed-state transition validation contract；Linux 在 `linux-artifact-readiness` 通过且 license/NOTICE 人工确认完成前不得进入 `package-linux`。
