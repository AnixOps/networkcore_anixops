...
- release summary 输出 Linux artifact license/NOTICE source contract 与 pending 状态。
...
- 下一步可以让 release placeholder summary 输出 license/NOTICE source contract 状态，仍不生成 artifact。
