...
- Linux artifact readiness/release gate 已纳入 foreground stop/release 合同检查、artifact manifest 输出合同和 license/NOTICE confirmation source contract；当前 pending marker 继续阻止 `package-linux` 和 release asset。
