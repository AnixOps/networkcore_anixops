...
| Settings | Login preferences, theme selection, explicit core installation, and managed JSON preflight. | `platform-windows`, `engine-singbox`, and existing managed config APIs. |
