...
- 下一步可以补充 Linux package workflow artifact bundle upload validation contract，明确真实 manifest
  checksum sidecar 生成后校验 release bundle 文件集、上传同一 release run workflow artifact 和仍不发布
  GitHub Release asset 的边界。
