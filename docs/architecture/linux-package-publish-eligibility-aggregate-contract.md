...
| `ci` | release workflow 按 release CI gate activation validation contract、release CI gate execution validation contract 和 release CI gate API implementation plan 自动读取同 repository、同 commit、`main` 分支成功 CI run | `blocked-placeholder` |
