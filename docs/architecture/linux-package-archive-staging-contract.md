...
- Linux package checksum manifest contract、publish/upload boundary contract 和 signing/attestation
  policy binding contract 已定义；下一步可以补充 Linux package release notes/rollback policy
