...
- 本文档保持在 README、ROADMAP、Release Strategy、Linux package manifest 设计、Linux CLI
  ...
  validation contract、release CI gate execution validation contract、release CI gate API implementation plan、Linux package artifact build command validation contract、Linux package artifact
