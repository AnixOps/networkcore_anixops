...
- 已新增 [iOS Network Extension Design](ios-network-extension-design.md) 和 [iOS Platform Adapter Source Contract](ios-platform-adapter-source-contract.md)，后续 iOS adapter 应先创建最小 `platform-ios` 纯 Rust 映射骨架。
