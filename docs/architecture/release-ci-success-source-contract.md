...
- Linux package runner/toolchain/target contract 已在 release placeholder 中输出；下一步可以
  补充 `package-linux` archive staging、文件来源和顶层目录组装合同，仍不生成 artifact。
