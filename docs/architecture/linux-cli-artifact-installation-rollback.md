...
- release placeholder 和 release summary 已列出 manifest output contract 字段与 license/NOTICE source contract confirmed 状态，真实 job 不得删除该可见性。
