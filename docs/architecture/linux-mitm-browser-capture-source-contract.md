...
发布边界：当前最新用户可下载 Linux artifact 是 `v0.1.1-alpha.1` prerelease，最新 stable 是
`v0.1.0`；本文描述 current `main` 源码合同。`v0.1.1-alpha.1` 继承 `v0.1.0` Linux 能力边界，并已覆盖
`verify --confirm`、`verify --confirm --target-url <url>`、`session-plan`、`--target-url`、
