...
- persistent subscription catalog source contract、schema version、explicit path、snapshot、redacted add report、`CommandSubscriptionCatalogStore::add_source` and contract test、以及 no default/remote/file fetch boundary 检查
