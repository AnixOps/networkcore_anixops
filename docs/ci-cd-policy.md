...
- config-core crate README、subscription parser source contract、Trojan/VLESS/VMess URL parser gates、Clash YAML parser gate 和 Rust workspace 覆盖检查
...
- Alpha Release Feature Matrix 检查，确保 README、ROADMAP、TODO、Release Strategy 和 alpha/rc/stable
  ...
  和 Clash YAML parser gate，以及已拍板的
