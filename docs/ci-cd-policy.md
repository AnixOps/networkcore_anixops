...
- persistent subscription catalog source contract、schema version、explicit path、snapshot、redacted add/list/remove report、`CommandSubscriptionCatalogStore::add_source`/`list_sources`/`remove_source` and contract tests、以及 no default/remote/file fetch boundary 检查
