...
- config-core crate README、subscription parser source contract、Trojan/VLESS/VMess URL parser gates、Clash YAML parser gate、sing-box JSON parser gate、Surge proxy line parser gate、Loon proxy line parser gate 和 Rust workspace 覆盖检查
...
- Alpha Release Feature Matrix 检查，确保 README、ROADMAP、TODO、Release Strategy 和 alpha/rc/stable
  ...
  Clash YAML parser gate、sing-box JSON parser gate、Surge proxy line parser gate 和 Loon proxy line parser gate，以及已拍板的
