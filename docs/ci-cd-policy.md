...
- placeholder 阶段必须通过 release summary job 显式输出发布来源、policy、release-ci-gate、artifact contract、signing contract、rollback contract、placeholder、artifact 状态和后续 artifact 门禁。
