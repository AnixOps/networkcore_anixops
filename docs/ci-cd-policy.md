...
- Alpha placeholder release version policy、Windows manual smoke 测试清单、pending marker 与 release placeholder/summary 输出检查
- 架构决策记录检查
