...
declare -a full_contracts=(
  ...
  $'subscription refresh schedule install\tdocs/architecture/subscription-background-refresh-source-contract.md'
  $'LinuxSubscriptionRefreshScheduleRequest\tcrates/platform-linux/src/systemd.rs'
  $'SubscriptionRefreshScheduleInstall\tapps/linux-cli/src/lib.rs'
